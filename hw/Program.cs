...
namespace Пианино1
{
    internal class Program
    {
        ...
        static void WriteChooseOperation()
        {
            ...
            Console.WriteLine("Переключение между октавами I и O.");
            Console.WriteLine("P - выход из программы.");
            ...
            else if (clavisha.Key == ConsoleKey.P)
            {
                Environment.Exit(0);
            }
        ...
        static void SecondOctavia()
        {
            ...
            while (clavisha.Key != ConsoleKey.I);
